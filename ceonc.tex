...
\begin{document}
\title{Modelos Multimodais de Linguagem para Imagens Médicas: Estudo do Google MedGemma 4B-IT}
\newif\iffinal
\finaltrue
\iffinal
    % \author{
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{figs/med.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{figs/GRAPH.png}
\caption{}
\label{fig:graph}
\end{figure}
