...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\linewidth]{fig002.jpeg}
\caption{segmentação manual com pygame}
\label{fig:fig02}
\end{figure}
