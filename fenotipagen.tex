...
Random Forest, as illustrated in Fig.~\ref{fig:randomforest}, is a machine learning model based on decision trees. It builds multiple trees and combines their results to obtain more robust predictions \cite{hastie2009elements}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{figs/intercecion_v3resnet_50.png}
