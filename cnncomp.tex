...
\begin{document}
\title{Classificação de Doenças em Plantas: Uma Comparação Entre Arquiteturas de CNN}
\newif\iffinal
\finaltrue
\iffinal
    % \author{
